    ...
    private suspend fun templateVariable(cookie: String, fields: String): JSONObject? =
        withContext(Dispatchers.IO) {
            ...
            val request = Request.Builder()
                ...
                // gettemplatevariable currently rejects the browser UA for an otherwise
                // valid BDUSS session. Use the same official netdisk client identity as
                // the authenticated management endpoints so login health is not misread.
