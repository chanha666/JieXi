...
fun DriveScreen(
    ...
    val quark = DriveAccount(
        id = "quark",
        name = "夸克网盘",
        description = quarkAccount?.nickname ?: "一键登录，授权仅保存在本机",
        avatarText = "夸",
    ...
    val uc = DriveAccount(
        id = "uc",
        name = "UC网盘",
        description = ucAccount?.nickname ?: "一键登录，授权仅保存在本机",
        avatarText = "UC",
    ...
    val xunlei = DriveAccount(
        id = "xunlei",
        name = "迅雷网盘",
        description = xunleiAccount?.nickname ?: "一键登录，授权仅保存在本机",
        avatarText = "迅",
    ...
    val baidu = DriveAccount(
        id = "baidu",
        name = "百度网盘",
        description = baiduAccount?.nickname ?: "一键登录，授权仅保存在本机",
        avatarText = "度",
    ...
    val c139 = DriveAccount(
        id = "c139",
        name = "139网盘",
        description = c139Account?.nickname ?: "一键登录，授权仅保存在本机",
        avatarText = "139",
    ...
    val pan123 = DriveAccount(
        id = "pan123",
        name = "123云盘",
        description = pan123Account?.nickname ?: "一键登录，授权仅保存在本机",
        avatarText = "123",
