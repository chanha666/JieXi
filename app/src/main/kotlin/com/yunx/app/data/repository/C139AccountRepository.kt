...
import com.yunx.app.data.security.PlatformCookieCleaner
...
class C139AccountRepository(
    ...
    suspend fun logoutC139() {
        runCatching {
            PlatformCookieCleaner.clear(
                listOf(C139Constants.COOKIE_DOMAIN, C139Constants.COOKIE_DOMAIN_BACKUP, C139Constants.LOGIN_URL)
            )
        }
        dao.clear()
    }
