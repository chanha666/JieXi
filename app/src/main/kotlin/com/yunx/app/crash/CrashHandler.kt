...
class CrashHandler(private val context: Context) : Thread.UncaughtExceptionHandler {
    ...
    private fun buildCrashLog(thread: Thread, throwable: Throwable): String {
        ...
        return buildString {
            ...
            appendLine()
            appendLine(LogRedactor.line(sw.toString()).take(MAX_REPORT_CHARS))
    ...
    private fun saveCrashLog(log: String) {
        runCatching {
            ...
            file.writeText(log)
            dir.listFiles { candidate -> candidate.name.startsWith("crash_") && candidate.extension == "txt" }
